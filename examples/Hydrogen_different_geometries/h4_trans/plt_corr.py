...
if __name__ == '__main__':
    ...
    for cnt, line in enumerate(f):
        ...
        if 'Mean-field energy (DG):' in line:
            ...
            if 'ccpvdz' in BS:
                if len(BS) > 7:
                    arccpvdz[0,0].plot(rot_a, mf_dg, 'o-b' ,label = 'HF (DG-V)')
                    #arccpvdz[0,0].set_title("aug-cc-pVDZ")
                    arccpvdz[0,0].legend()
                    arccpvdz[1,0].semilogy(rot_a, [a-b for a,b in zip(mf,mf_dg)],
                            'o-b' ,label = 'HF')
                    arccpvdz[1,0].set_ylim(1e-5, 1e-2)
                    arccpvdz[1,0].set_ylabel('Enegry difference ($E - E^{(DG-V)}$)')
                    ...
                    arccpvdz[1,0].legend(frameon = False, loc = 4)
                elif len(BS) < 8:
                    arccpvdz[0,1].plot(rot_a, mf_dg, 'o-b' ,label = 'HF (DG-V)')
                    arccpvdz[1,1].semilogy(rot_a, [a-b for a,b in zip(mf,mf_dg)],
                            'o-b' ,label = 'HF')
                    arccpvdz[1,1].set_ylim(1e-5, 1e-2)
                    ...
                    arccpvdz[1,1].legend(frameon = False, loc = 4)
            elif '6311' in BS:
                if len(BS) == 8:
                    ar6311[0,0].plot(rot_a, mf_dg, 'o-b' ,label = 'HF (DG-V)')
                    ar6311[0,0].legend()
                    ar6311[1,0].semilogy(rot_a, [a-b for a,b in zip(mf,mf_dg)], 
                            'o-b' ,label = 'HF')
                    ar6311[1,0].set_ylim(1e-4, 5e-2)
                    ar6311[1,0].set_ylabel('Enegry difference ($E - E^{(DG-V)}$)')
                    ar6311[1,0].set_xlabel('angle ($\\alpha$) in degree')
                    ar6311[1,0].spines['top'].set_visible(False)
                    ar6311[1,0].spines['right'].set_visible(False)
                    ar6311[1,0].legend(frameon = False, loc = 4)
                elif len(BS) == 6:
                    ar6311[0,1].plot(rot_a, mf_dg, 'o-b' ,label = 'HF (DG-V)')
                    ar6311[0,1].legend()
                    ar6311[1,1].semilogy(rot_a, [a-b for a,b in zip(mf,mf_dg)], 
                            'o-b' ,label = 'HF')
                    ar6311[1,1].set_ylim(1e-4, 5e-2)
                    ar6311[1,1].set_xlabel('angle ($\\alpha$) in degree')
                    ar6311[1,1].spines['top'].set_visible(False)
                    ar6311[1,1].spines['right'].set_visible(False)
                    ar6311[1,1].legend(frameon = False, loc = 4)
            elif '631' in BS and '11' not in BS:
                if len(BS) == 7:
                    ar631[0,0].plot(rot_a, mf_dg, 'o-b' ,label = 'HF (DG-V)')
                    ar631[0,0].legend()
                    ar631[1,0].semilogy(rot_a, [a-b for a,b in zip(mf,mf_dg)], 
                            'o-b' ,label = 'HF')
                    ar631[1,0].set_ylim(1e-4, 5e-2)
                    ar631[1,0].set_ylabel('Enegry difference ($E - E^{(DG-V)}$)')
                    ar631[1,0].set_xlabel('angle ($\\alpha$) in degree')
                    ar631[1,0].spines['top'].set_visible(False)
                    ar631[1,0].spines['right'].set_visible(False)
                    ar631[1,0].legend(frameon = False, loc = 4)
                elif len(BS) == 5:
                    ar631[0,1].plot(rot_a, mf_dg, 'o-b' ,label = 'HF (DG-V)')
                    ar631[0,1].legend()
                    ar631[1,1].semilogy(rot_a, [a-b for a,b in zip(mf,mf_dg)], 
                            'o-b' ,label = 'HF')
                    ar631[1,1].set_ylim(1e-4, 5e-2)
                    ar631[1,1].set_xlabel('angle ($\\alpha$) in degree')
                    ar631[1,1].spines['top'].set_visible(False)
                    ar631[1,1].spines['right'].set_visible(False)
                    ar631[1,1].legend(frameon = False, loc = 4)
            elif '321' in BS:
                if len(BS) == 7:
                    ar321[0,0].plot(rot_a, mf_dg, 'o-b' ,label = 'HF (DG-V)')
                    #ar321[0,0].set_title("3-21++G")
                    ar321[0,0].legend()
                    ar321[1,0].semilogy(rot_a, [a-b for a,b in zip(mf,mf_dg)], 'o-b' ,label = 'HF')
                    ar321[1,0].legend(frameon = False, loc = 4)
                elif len(BS) == 5:
                    ar321[0,1].plot(rot_a, mf_dg, 'o-b' ,label = 'HF (DG-V)')
                    #ar321[0,1].set_title("3-21G")
                    ar321[0,1].legend()
                    ar321[1,1].semilogy(rot_a, [a-b for a,b in zip(mf,mf_dg)], 'o-b' ,label = 'HF')
                    ar321[1,1].legend(frameon = False, loc = 4)
        ...
        if 'MP2 corr. energy :' in line:
            ...
            if 'ccpvdz' in BS:
                ...
                #    ar631[0,1].legend()
                    ...
                    ar631[0,1].legend(frameon = False, loc = 4)
            elif '321' in BS:
                if len(BS) == 7:
                    ar321[0,0].plot(rot_a, mp, 'v-k' ,label = 'MP2')
                    #ar321[0,0].set_title("3-21++G")
                    ar321[0,0].legend(frameon = False, loc = 4)
                elif len(BS) == 5:
                    ar321[0,1].plot(rot_a, mp, 'v-k' ,label = 'MP2')
                    #ar321[0,1].set_title("3-21G")
                    ar321[0,1].legend(frameon = False, loc = 4)
        ...
        if 'MP2 corr. energy (DG) :' in line:
            ...
            if 'ccpvdz' in BS:
                if len(BS) > 7:
                    arccpvdz[0,0].plot(rot_a, mp_dg, 'v-b' ,label = 'MP2 (DG-V)')
                    #arccpvdz[0,0].set_title("aug-cc-pVDZ")
                    arccpvdz[0,0].legend()
                    arccpvdz[1,0].semilogy(rot_a, [a-b for a,b in zip(mp,mp_dg)], 'v-b' ,label = 'MP2')
                    arccpvdz[1,0].legend(frameon = False, loc = 4)
                elif len(BS) < 8:
                    arccpvdz[0,1].plot(rot_a, mp_dg, 'v-b' ,label = 'MP2 (DG-V)')
                    #arccpvdz[0,1].set_title("cc-pVDZ")
                    arccpvdz[0,1].legend(frameon = False, loc = 4)
                    arccpvdz[1,1].semilogy(rot_a, [a-b for a,b in zip(mp,mp_dg)], 'v-b' ,label = 'MP2')
                    arccpvdz[1,1].legend()
            elif '6311' in BS:
                if len(BS) == 8:
                    ar6311[0,0].plot(rot_a, mp_dg, 'v-b' ,label = 'MP2 (DG-V)')
                    #ar6311[0,0].set_title("6-311++G")
                    ar6311[0,0].legend()
                    ar6311[1,0].semilogy(rot_a, [a-b for a,b in zip(mp,mp_dg)], 'v-b' ,label = 'MP2')
                    ar6311[1,0].legend(frameon = False, loc = 4)
                #elif len(BS) == 7:
                #    ar6311[0,1].plot(rot_a, mp_dg, 'v-b' ,label = 'MP2 (DG-V)')
                #    #ar6311[0,1].set_title("6-311+G")
                #    ar6311[0,1].legend()
                ...
                #    ar6311[1,1].legend()
                    ...
                    ar6311[0,1].plot(rot_a, mp_dg, 'v-b' ,label = 'MP2 (DG-V)')
                    #ar6311[0,1].set_title("6-311G")
                    ar6311[0,1].legend(frameon = False, loc = 4)
                    ar6311[1,1].semilogy(rot_a, [a-b for a,b in zip(mp,mp_dg)], 'v-b' ,label = 'MP2')
                    ar6311[1,1].legend()
            elif '631' in BS and '11' not in BS:
                if len(BS) == 7:
                    ar631[0,0].plot(rot_a, mp_dg, 'v-b' ,label = 'MP2 (DG-V)')
                    #ar631[0,0].set_title("6-31++G")
                    ar631[0,0].legend()
                    ar631[1,0].semilogy(rot_a, [a-b for a,b in zip(mp,mp_dg)], 'v-b' ,label = 'MP2')
                    ar631[1,0].legend(frameon= False, loc = 4)
                #elif len(BS) == 6:
                #    ar631[0,1].plot(rot_a, mp_dg, 'v-b' ,label = 'MP2 (DG-V)')
                #    #ar631[0,1].set_title("6-31+G")
                #    ar631[0,1].legend()
                ...
                if len(BS) == 7:
                    ar321[0,0].plot(rot_a, mp_dg, 'v-b' ,label = 'MP2 (DG-V)')
                    #ar321[0,0].set_title("3-21++G")
                    ar321[0,0].legend()
                    ar321[1,0].semilogy(rot_a, [a-b for a,b in zip(mp,mp_dg)], 'v-b' ,label = 'MP2')
                    ar321[1,0].legend(frameon = False, loc = 4)
                elif len(BS) == 5:
                    ar321[0,1].plot(rot_a, mp_dg, 'v-b' ,label = 'MP2 (DG-V)')
                    #ar321[0,1].set_title("3-21G")
                    ar321[0,1].legend(frameon = False)
        ...
        if 'CCSD corr. energy (DG):' in line:
            ...
            if 'ccpvdz' in BS:
                if len(BS) > 7:
                    arccpvdz[0,0].plot(rot_a, cc_dg, 'x-b' ,label = 'CCSD (DG-V)')
                    #arccpvdz[0,0].set_title("aug-cc-pVDZ")
                    arccpvdz[0,0].legend()
                    arccpvdz[1,0].semilogy(rot_a, [a-b for a,b in zip(mp,mp_dg)], 'x-b' ,label = 'CCSD')
                    arccpvdz[1,0].legend()
                elif len(BS) < 8:
                    arccpvdz[0,1].plot(rot_a, cc_dg, 'x-b' ,label = 'CCSD (DG-V)')
                    #arccpvdz[0,1].set_title("cc-pVDZ")
                    arccpvdz[0,1].legend()
                ...
                if len(BS) == 8:
                    ar6311[0,0].plot(rot_a, cc_dg, 'x-b' ,label = 'CCSD (DG-V)')
                    #ar6311[0,0].set_title("6-311++G")
                    ar6311[0,0].legend()
                    ar6311[1,0].semilogy(rot_a, [a-b for a,b in zip(mp,mp_dg)], 'x-b' ,label = 'CCSD')
                    ar6311[1,0].legend()
                #elif len(BS) == 7:
                #    ar6311[0,1].plot(rot_a, cc_dg, 'x-b' ,label = 'CCSD (DG-V)')
                #    #ar6311[0,1].set_title("6-311+G")
                #    ar6311[0,1].legend()
                ...
                if len(BS) == 7:
                    ar631[0,0].plot(rot_a, cc_dg, 'x-b' ,label = 'CCSD (DG-V)')
                    #ar631[0,0].set_title("6-31++G")
                    ar631[0,0].legend()
                    ar631[1,0].semilogy(rot_a, [a-b for a,b in zip(mp,mp_dg)], 'x-b' ,label = 'CCSD')
                    ar631[1,0].legend()
                #elif len(BS) == 6:
                #    ar631[0,1].plot(rot_a, cc_dg, 'x-b' ,label = 'CCSD (DG-V)')
                #    #ar631[0,1].set_title("6-31+G")
                #    ar631[0,1].legend()
                ...
                if len(BS) == 7:
                    ar321[0,0].plot(rot_a, cc_dg, 'x-b' ,label = 'CCSD (DG-V)')
                    #ar321[0,0].set_title("3-21++G")
                    ar321[0,0].legend()
                    ar321[1,0].semilogy(rot_a, [a-b for a,b in zip(mp,mp_dg)], 'x-b' ,label = 'CCSD')
                    ar321[1,0].legend()
                elif len(BS) == 5:
                    ar321[0,1].plot(rot_a, cc_dg, 'x-b' ,label = 'CCSD (DG-V)')
                    #ar321[0,1].set_title("3-21G")
                    ar321[0,1].legend()
