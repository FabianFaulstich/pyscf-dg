...
if __name__ == '__main__':
    ...
    for cnt, line in enumerate(f):
        ...
        if 'Mean-field energy:' in line:
            ...
            if '321' in BS:
                if len(BS) == 7:
                    ar0.plot(rot_a, mf, 'o-k' ,label = 'HF (3-21++G)')
                    ...
                    ar1.plot(rot_a, mf, 'o-k' ,label = 'HF (3-21G)')
        ...
        if 'MP2 corr. energy (DG) :' in line:
            ...
            if '321' in BS:
                if len(BS) == 7:
                    ...
                    ar2.semilogy(rot_a, [a-b for a,b in zip(mp,mp_dg)], 'v-b' ,
                            label = 'MP2')
                elif len(BS) == 5:
        ...
        if 'CCSD corr. energy (DG):' in line:
            ...
            if '321' in BS:
                if len(BS) == 7:
                    ...
                    ar2.semilogy(rot_a, [a-b for a,b in zip(mp,mp_dg)], 'x-b' ,
                            label = 'CCSD')
                elif len(BS) == 5:
    ...
    ar2.legend(loc = 'lower right')
    ar3.legend(loc = 'lower right')
    
    
    #ar2.set_yscale('log')
    #ar2.set_yticks([2e-3, 1e-2])
