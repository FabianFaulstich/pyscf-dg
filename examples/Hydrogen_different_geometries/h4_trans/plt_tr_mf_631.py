        ...
        if mf_iter:
            ...
            if mf_plt:
                ...
                if '631' in BS and '11' not in BS:
                    if len(BS) == 7:
                        ar0.plot(rot_a,mf[1:],'D-k', label = '6-31++G')
                        ar0.set_ylim(-2.17,-2.02)
