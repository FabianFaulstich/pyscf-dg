...
if __name__ == '__main__':
    ...
    for i, diss in enumerate(rel_dis): 
        ...
        # Voronoi 2D:
        # Using 2D projection of atom position
        ...
        start_dg = time.time()
        cell_dg  = dg.dg_model_ham(cell, None,'rel_num', 0.99) # default setting dg_trunc = 'abs_tol', svd_tol = 1e-3
